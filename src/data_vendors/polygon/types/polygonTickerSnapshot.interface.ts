...
/**
 * Utility fn. to create an default PolygonTickerSnapshot
 * Useful for testing or initializing empty snapshots
 */
export function createTickerSnapshot(overrides: Partial<PolygonTickerSnapshot> = {}): PolygonTickerSnapshot {
