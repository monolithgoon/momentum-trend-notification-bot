...
const LEADERBOARD_PRUNE_CONFIG_SPEC: {
...
// History bounds
const LEADERBOARD_MAX_SNAPSHOT_HISTORY_LOOKBACK: number | undefined = undefined; // if undefined, derivedProps from windows * 6
...
// Leaderboard sizing
const LEADERBOARD_MAX_SNAPSHOT_LENGTH = 10
