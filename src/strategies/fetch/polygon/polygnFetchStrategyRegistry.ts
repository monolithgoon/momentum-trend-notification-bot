// src/strategies/fetch-strategy/polygon/polygonStrategyRegistry.ts

import { PolygonFetchStrategy_2 } from './polygonFetchStrategy.interface';
...
export const polygonStrategyRegistry: Record<string, PolygonFetchStrategy_2> = {
...
export type PolygonStrategyKey = keyof typeof polygonStrategyRegistry;
